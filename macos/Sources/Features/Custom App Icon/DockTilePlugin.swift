...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.systivate.ghostty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.systivate.ghostty")
    #endif
