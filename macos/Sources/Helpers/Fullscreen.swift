...
extension Notification.Name {
    static let fullscreenDidEnter = Notification.Name("com.systivate.ghostty.fullscreenDidEnter")
    static let fullscreenDidExit = Notification.Name("com.systivate.ghostty.fullscreenDidExit")
}
